// megafunction wizard: %Viterbi v13.0%
// GENERATION: XML
...
module Viterbi (
	...
	wire [1:1] signal_wire0 = 1'b0;
	wire [1:1] signal_wire1 = 1'b0;
	...
	auk_vit_par_top_atl	auk_vit_par_top_atl_inst(
		...
		.rr(rr),
		.eras_sym(eras_sym),
		.state_node_sync(signal_wire0),
		.sel_code(signal_wire1),
		.tb_type(tb_type),
		.ber_clear(signal_wire2),
	...
	defparam
		...
		auk_vit_par_top_atl_inst.best_state_finder = "used",
		auk_vit_par_top_atl_inst.parallel_optimization = "none",
...
// Retrieval info: <MEGACORE title="Viterbi Compiler"  version="13.0"  build="156"  iptb_version="1.3.0 Build 156"  format_version="120" >
...
// Retrieval info:      <PRIVATE name = "parallel_optimization" value="none"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "best_state_finder" value="1"  type="BOOLEAN"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "TRACEBACK" value="42"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "NUM_BLOCKS" value="1"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "NOISE_RATIO" value="10.0"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "DECIMALOCTAL" value="octal"  type="STRING"  enable="1" />
